...
const AdminComponent = () => {
    ...
    <div className="flex h-screen justify-center bg-gray-100">
      <div className="p-6 rounded w-full max-w-md">
        {pendingApproval.length === 0 ? (
          <p className="text-white text-center">No pending approvals</p>
        ) : (
  ...
  <div className="space-y-4 overflow-y-auto max-h-[70vh] text-sm text-gray-800">
    <section>
      <h3 className="text-lg font-semibold mb-1">Student Details</h3>
      <p><strong>Acknowledgement Number:</strong> {popupData.acknowledgementNumber}</p>
      <p><strong>Aadhaar ID:</strong> {popupData.aadharID}</p>
      <p><strong>Student Name:</strong> {popupData.studentName}</p>
      <p><strong>Class:</strong> {popupData.studentClass}</p>
      <p><strong>Gender:</strong> {popupData.gender}</p>
      <p><strong>Program:</strong> {popupData.program}</p>
      <p><strong>Category:</strong> {popupData.category}</p>
      <p><strong>Parent's Contact:</strong> {popupData.parentsContactNumber}</p>
    </section>

    <section>
      <h3 className="text-lg font-semibold mb-1">Parent Details</h3>
      <p><strong>Father's Name:</strong> {popupData.fatherName}</p>
      <p><strong>Father's Aaadhaar Card:</strong> {popupData.fatherAadharId}</p>
      <p><strong>Father's Occupations:</strong> {popupData.fatherOccupations}</p>
      <p><strong>Mother's Name:</strong> {popupData.motherName}</p>
      <p><strong>Mother's Aaadhaar Card:</strong> {popupData.motherAadharId}</p>
      <p><strong>Mother's Occupations:</strong> {popupData.motherOccupations}</p>
    </section>

    <section>
      <h3 className="text-lg font-semibold mb-1">Bank Details</h3>
      <p><strong>Bank Name:</strong> {popupData.bankName}</p>
      <p><strong>Account Holder:</strong> {popupData.accountHolder}</p>
      <p><strong>Account Number:</strong> {popupData.accountNumber}</p>
      <p><strong>IFSC Code:</strong> {popupData.ifscCode}</p>
    </section>
    ...
    <section>
      ...
      <div className="grid grid-cols-2 gap-4">
        {popupData.documents.cancelledCheque && (
          <div>
            <p className="font-medium">Cancelled Cheque</p>
            <a href={popupData.documents.cancelledCheque} target="_blank" rel="noreferrer">
              <img
                src={popupData.documents.cancelledCheque}
        ...
        {popupData.documents.passbook && (
          <div>
            <p className="font-medium">Passbook</p>
            <a href={popupData.documents.passbook} target="_blank" rel="noreferrer">
              <img
                src={popupData.documents.passbook}
                alt="Passbook"
                className="w-full h-24 object-cover border rounded hover:scale-105 transition"
              />
            </a>
        ...
        {popupData.documents.studentAadhar && (
          <div>
            <p className="font-medium">Student Aadhar</p>
            <a href={popupData.documents.studentAadhar} target="_blank" rel="noreferrer">
              <img
                src={popupData.documents.studentAadhar}
                alt="Student Aadhar"
                className="w-full h-24 object-cover border rounded hover:scale-105 transition"
              />
            </a>
        ...
        {popupData.documents.parentAadhar && (
          <div>
            <p className="font-medium">Parent Aadhar</p>
            <a href={popupData.documents.parentAadhar} target="_blank" rel="noreferrer">
              <img
                src={popupData.documents.parentAadhar}
                alt="Parent Aadhar"
                className="w-full h-24 object-cover border rounded hover:scale-105 transition"
              />
            </a>
        ...
        {popupData.documents.passportPhotos && (
          <div>
            <p className="font-medium">Passport Photos</p>
            <a href={popupData.documents.passportPhotos} target="_blank" rel="noreferrer">
              <img
                src={popupData.documents.passportPhotos}
                alt="Passport Photos"
                className="w-full h-24 object-cover border rounded hover:scale-105 transition"
              />
            </a>
